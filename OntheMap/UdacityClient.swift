...
class UdacityClient: NSObject {
    ...
    func taskForPOSTMethod(_ method: String, jsonBody: String, completionHandlerForPOST: @escaping (_ result: AnyObject?, _ error: NSError?) -> Void) -> URLSessionDataTask {
        ...
        let request = NSMutableURLRequest(url: udacityURLFromParametersPost(withPathExtension: method))
    ...
    // create a URL from parameters
    private func udacityURLFromParametersPost(withPathExtension: String? = nil) -> URL {
    ...
    //MARK:- Check for network reachability 
